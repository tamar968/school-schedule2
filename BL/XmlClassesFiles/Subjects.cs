public class XmlSubjects
{
    ...
    public partial class rootData
    {
        ...
        private byte dfShehiaField;

        private bool dfShehiaFieldSpecified;

        private byte dfTomhotField;

        private bool dfTomhotFieldSpecified;
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute()]
        public byte DfShehia
        {
            get
            {
                return this.dfShehiaField;
            }
            set
            {
                this.dfShehiaField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool DfShehiaSpecified
        {
            get
            {
                return this.dfShehiaFieldSpecified;
            }
            set
            {
                this.dfShehiaFieldSpecified = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute()]
        public byte DfTomhot
        {
            get
            {
                return this.dfTomhotField;
            }
            set
            {
                this.dfTomhotField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool DfTomhotSpecified
        {
            get
            {
                return this.dfTomhotFieldSpecified;
            }
            set
            {
                this.dfTomhotFieldSpecified = value;
            }
        }
    }
